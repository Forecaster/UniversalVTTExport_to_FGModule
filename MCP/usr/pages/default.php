...
class ModuleDefault extends BaseModule {
	...
	public static function Content1() {
		...
		<p>There is also a <a href="https://github.com/Forecaster/UniversalVTTExport_to_FGModule">GitHub repository</a> where you can find the code for this page as well as the Python script. There you can also <a href="https://github.com/Forecaster/UniversalVTTExport_to_FGModule/issues/new/choose">report issues</a> related to this project.</p>
